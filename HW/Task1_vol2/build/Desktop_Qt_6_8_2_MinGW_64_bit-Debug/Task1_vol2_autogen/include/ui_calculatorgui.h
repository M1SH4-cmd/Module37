...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(pushButton_16, SIGNAL(clicked()), MainWindow, SLOT(clearLine()));
        QObject::connect(pushButton_17, SIGNAL(clicked()), MainWindow, SLOT(backspace()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_17->setText(QCoreApplication::translate("MainWindow", "Backspace", nullptr));
    } // retranslateUi
